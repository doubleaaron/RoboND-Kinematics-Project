...
# Author: I extensively utilized, tweaked and augmented Harsh Pandya's code since it was so good, I learned so much from it, thanks Harsh!
...
def handle_calculate_IK(req):
    ...
    if len(req.poses) < 1:
        ...
        ### Your FK code here
        # Create symbols for all the joint variables
        ...
        # roll, pitch, yaw = end-effector orientation
            ...
            ### Your IK code here 
        # Compensation for rotation discrepancy between DH parameters and Gazebo
